    ...
    <main>
      <article id="banner">
        <div id="bannerhead">
          ...
          <p id="bannertitle">It looks like you need to sign up!</p>
...
if ($_SERVER['REQUEST_METHOD']=='POST'){
        ...
        if(!empty($_REQUEST['name'])){
            $name = mysqli_real_escape_string($dbc, trim($_REQUEST['name']));
        } else {
            $errors = $errors . "<p>You didn't enter a name.</p>";
        }
      ...
      <form action="signup.php" method="post">
          ...
          <p style="color: white">Name:</p> <input type="text" name="name" value="<?php if (isset($_POST['name'])) echo $_POST['name'];?>"><br>
